 ...
 * TODO: For first time users should pickup color preference
 *
 ...
 * !It might be an overkill... if theme toggling and `outside styled components|MUI styles` doesnt get used
 * !it will be removed
 *
 *
 */
